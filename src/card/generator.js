 ...
 * @returns {{canvas: HTMLCanvasElement, cardState: {text: string, category: string, signature: string, layout: string, fontStyle: string, rendererVersion: 'v1' | 'v2' | 'v3' | 'v4', postProcessSeed: number}}}
 */
 ...
 * @returns {asserts rendererVersion is 'v4'}
 */
function assertKnownRendererVersion(rendererVersion) {
  if (rendererVersion !== CARD_RENDERER_VERSIONS.v4) {
