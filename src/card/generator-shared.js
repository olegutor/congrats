...
/** @type {Readonly<{v1: 'v1', v2: 'v2', v3: 'v3'}>} */
...
/** @type {ReadonlyArray<'v1' | 'v2' | 'v3'>} */
export const CARD_RENDERER_VERSION_LIST = Object.freeze(['v1', 'v2', 'v3']);
 ...
 * @param {'v1' | 'v2' | 'v3'} rendererVersion
 * @param {'ru' | 'en'} [language]
 * @returns {{text: string, category: string, signature: string, layout: string, fontStyle: string, rendererVersion: 'v1' | 'v2' | 'v3', postProcessSeed: number}}
 */
export function createRandomCardState(rendererVersion, language = 'ru') {
  const version = rendererVersion ?? CARD_RENDERER_VERSIONS.v3;
  assert(
