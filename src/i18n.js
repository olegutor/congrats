...
const UI_STRINGS = Object.freeze({
  ru: Object.freeze({
    ...
    exportSize: "Размер PNG",
    exportSizeCompact: "Малый (~250 КБ)",
    exportSizeMedium: "Средний (~400 КБ)",
    exportSizeFull: "Полный (~2 МБ)",
  ...
  en: Object.freeze({
    ...
    exportSize: "PNG size",
    exportSizeCompact: "Small (~250 KB)",
    exportSizeMedium: "Medium (~400 KB)",
    exportSizeFull: "Full (~2 MB)",
